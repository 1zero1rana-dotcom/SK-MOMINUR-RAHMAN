...
export default function Hero() {
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-16 pb-24 lg:pt-32 lg:pb-40">
      ...
      <div className="absolute top-0 left-1/2 -z-10 h-[800px] w-[800px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/5 blur-3xl opacity-70" />
      <div className="absolute bottom-0 right-0 -z-10 h-[400px] w-[400px] rounded-full bg-secondary/10 blur-3xl opacity-50" />
        ...
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          ...
          >
            ...
            <h1 className="text-5xl font-extrabold tracking-tight text-gray-900 sm:text-6xl lg:text-7xl leading-[1.1]">
              {settings.heroTitle.split(' ').slice(0, -2).join(' ')} <span className="text-primary">{settings.heroTitle.split(' ').slice(-2).join(' ')}</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                ...
                className="group flex items-center gap-2 rounded-full bg-primary px-8 py-4 text-lg font-bold text-white shadow-xl shadow-primary/20 transition-all hover:bg-primary/90 hover:shadow-primary/30"
              >
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative aspect-square overflow-hidden rounded-3xl bg-primary/10 shadow-2xl shadow-primary/20">
              <img
